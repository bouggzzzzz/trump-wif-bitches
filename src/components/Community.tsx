    ...
    <div className="bg-gradient-to-b from-trump-red to-black py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <a href="https://x.com/TRUMPWIFBITCHES" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center p-6 bg-black bg-opacity-50 rounded-lg hover:bg-opacity-70 transition-all">
